...
public class ClienteSelectionController {
    ...
    public void initialize() {
        ...
        master.addAll(
                new Cliente(101, "RoseFlower INC.",   "Av. Petalos 123", "0991234567", "rosa@rose.com"),
                new Cliente(102, "SweetMoment Ltd.",  "Calle Tulipán 45","0987654321", "sm@moment.com")
                // … más si quieres …
        );
        ...
        // filtros
        txtFilterNombre.textProperty().addListener((obs, o, v) ->
                filtered.setPredicate(c ->
                        v.isEmpty() || c.getNombre().toLowerCase().contains(v.toLowerCase())
                )
        );
