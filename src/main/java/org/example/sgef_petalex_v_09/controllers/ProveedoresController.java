...
public class ProveedoresController {
    ...
    public void initialize() {
        ...
        masterData.addAll(
                ...
                new Proveedor("1791512345002", "Florícolas Galápagos", "+593998223344", "Puerto Ayora, Galápagos",
                        "Activo"),
                ...
                new Proveedor("1791512345015", "Flores del Chillogallo", "+593996656667", "Quito, Pichincha",
                        "Activo"));
    ...
    private Optional<Proveedor> showForm(String title, Proveedor existing) {
        ...
        TextField fRuc = new TextField();
        fRuc.setPromptText("RUC");
        TextField fNombre = new TextField();
        fNombre.setPromptText("Nombre");
        TextField fTelefono = new TextField();
        fTelefono.setPromptText("Teléfono");
        TextField fDireccion = new TextField();
        fDireccion.setPromptText("Dirección");
        ...
        g.add(new Label("RUC:"), 0, 0);
        g.add(fRuc, 1, 0);
        g.add(new Label("Nombre:"), 0, 1);
        g.add(fNombre, 1, 1);
        g.add(new Label("Teléfono:"), 0, 2);
        g.add(fTelefono, 1, 2);
        g.add(new Label("Dirección:"), 0, 3);
        g.add(fDireccion, 1, 3);
        g.add(new Label("Estado:"), 0, 4);
        g.add(fEst, 1, 4);
