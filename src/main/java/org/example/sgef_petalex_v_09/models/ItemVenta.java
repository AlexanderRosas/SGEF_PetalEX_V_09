...
public class ItemVenta {
    ...
    public StringProperty variedadProperty() {
        return variedad;
    }
    ...
    public StringProperty paqueteProperty() {
        return paquete;
    }
    ...
    public void setPrecioUnit(double p) {
        precioUnit.set(p);
    }
    ...
    public void setPrecioTotal(double t) {
        precioTotal.set(t);
    }
    ...
    public Object getDescripcion() {
        return "Item: " + item + " - " + variedad + " - " + paquete + " - " + cantidad + " - " + precioUnit + " - "
                + precioTotal;
    }
    ...
    public int getUnidadesTotales() {
        // La cantidad es número de cajas
        int numeroDeCajas = getCantidad();

        // El tipo de paquete es string, necesitas obtener el enum
        Rosa.TipoEmpaque tipoEmpaqueEnum = Rosa.TipoEmpaque.valueOf(getPaquete().toUpperCase().replace(" ", "_"));

        int unidadesPorCaja = tipoEmpaqueEnum.getCantidad();

        return numeroDeCajas * unidadesPorCaja;
    }
